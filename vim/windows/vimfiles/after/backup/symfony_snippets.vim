...
exec "Snippet get public function get".st.et." (){<CR><TAB>return $this->".st.et.";<CR><BS>}<CR><CR>".st.et
exec "Snippet link_to link_to('".st."linkName".et."', '".st."moduleName".et."/".st."actionName".et.st.et."')".st.et
exec "Snippet sexecute public function execute<Action>(){<CR><TAB>".st.et."<CR><BS>}<CR>".st.et
exec "Snippet set public function set".st.et." ($".st.et."){<CR><TAB>$this->".st.et." = ".st.et.";<CR><BS>}<CR><CR>".st.et
exec "Snippet execute /**<CR>* ".st."className".et."<CR>*<CR>*/<CR>public function execute<Action>(){<CR><TAB>".st.et."<CR><BS>}<CR>".st.et
...
exec "Snippet setget public function set".st."var".et." (".st."arg".et."){<CR><TAB>$this->".st."arg".et." = ".st."arg".et.";<CR><BS>}<CR><CR>public function get".st."var".et." ()<CR>{<CR>return $this->".st."var".et.";<CR>}<CR><CR>".st.et
